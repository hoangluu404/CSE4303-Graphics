...
static void computePatch( Parameters *paramsP, int p )
{
  ...
  for ( int m=0; m < r; m++ ) {
    ...
    // TODO : Declare u and initialize it to the correct value
    //          using m.
    ...
    for ( int n=0; n < r; n++ ) {
      ...
      // TODO : Declare v and initialize it to the correct value
      //          using n.
      ...
      for ( int i=0; i<=3; i++ ) {
        ...
        for ( int j=0; j<=3; j++ ) {
          ...
          // TODO : Declare c and initialize it to the correct
          ...
          // TODO : Update ptP's x, y, z elements properly using
          //          c, cpP, and cpNum.
...
static FLOAT64 computeCoefficient( int i, int j, FLOAT64 u, FLOAT64 v )
{
  ...
  switch ( i ) {
    ...
    case 1 :
      // Switch on the column number ...
      switch ( j ) {
        // TODO : Fill in cases 0, 1, 2, 3, and default using the
