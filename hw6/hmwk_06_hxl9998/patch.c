  ...
  switch ( i ) {
    ...
    case 1 :
      ...
      switch ( j ) {
        ...
        case 1 : result = 3 * v     * 3*u*mu*mu * mv*mv;    break;
        case 2 : result = 3 * v*v   * 3*u*mu*mu * mv;       break;
        case 3 : result =     v*v*v * 3*u*mu*mu;            break;
      }
      break;
    ...
    case 2 :
      ...
      switch ( j ) {
        ...
        case 1 : result = 3 * v     * 3*u*u*mu * mv*mv;    break;
        case 2 : result = 3 * v*v   * 3*u*u*mu * mv;       break;
        case 3 : result =     v*v*v * 3*u*u*mu;            break;
      }
      break;
    ...
    case 3 :
      ...
      switch ( j ) {
        ...
        case 1 : result = 3 * v     * u*u*u * mv*mv;    break;
        case 2 : result = 3 * v*v   * u*u*u * mv;       break;
        case 3 : result =     v*v*v * u*u*u;            break;
      }
      break;
